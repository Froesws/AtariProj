...
#
# Atari2600.tcl: Tcl script for re-creating project 'Atari2600'
#
...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xc7vx485tffg1157-1 -quiet -force
...
set obj [get_filesets sources_1]
set_property -name "top" -value "atariTop" -objects $obj

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/Atari2600.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci" ]\
]
set added_files [add_files -fileset sources_1 $files]
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/atariTop_behav.wcfg" ]\
]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7vx485tffg1157-1 -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7vx485tffg1157-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
